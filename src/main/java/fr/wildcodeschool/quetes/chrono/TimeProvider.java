...
public interface TimeProvider {
    ...
    /**
     * Switch that starts the chrono if it was stopped,
     * and stops (pauses actually) the chrono if it was running
     */
    void startStop();

    /**
     * resets the amount of time since the chrono start,
     * so that if you run getSecondsTotalRuntime()  immediately after reset() you get OL
     */
    void reset();
